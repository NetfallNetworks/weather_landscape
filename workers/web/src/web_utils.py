...
def load_template(template_name):
    ...
    Decoder/scene art now uses the real landscape sprite PNGs (served from
    assets/sprites/ and referenced directly by <img>/<image>), so there is no
    inline-sprite injection step here.
    """
